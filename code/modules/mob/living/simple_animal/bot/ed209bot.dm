...
/mob/living/simple_animal/bot/secbot/ed209/attack_hand(mob/living/carbon/human/H)
	if(H.a_intent == INTENT_HARM)
		retaliate(H)
	return ..()

/mob/living/simple_animal/bot/secbot/ed209/attackby(obj/item/W, mob/user, params)
	..()
...
/mob/living/simple_animal/bot/secbot/ed209/bullet_act(obj/item/projectile/Proj)
...
/mob/living/simple_animal/bot/secbot/ed209/attack_alien(mob/living/carbon/alien/user)
	..()
	if(!isalien(target))
		target = user
		mode = BOT_HUNT
...
/mob/living/simple_animal/bot/secbot/ed209/proc/reenable()
	disabled = FALSE
...
/mob/living/simple_animal/bot/secbot/ed209/UnarmedAttack(atom/A)
	if(!on)
		return
	if(iscarbon(A))
...
/mob/living/simple_animal/bot/secbot/ed209/hitby(atom/movable/AM, skipcatch = FALSE, hitpush = TRUE, blocked = FALSE, datum/thrownthing/throwingdatum)
